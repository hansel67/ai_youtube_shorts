...
def upload_video(file,title,description,keywords):

    category = "22"  # Default category
    ...
    try:
        initialize_upload(youtube, file, title, description, category, keywords, privacy_status)
    except HttpError as e:
